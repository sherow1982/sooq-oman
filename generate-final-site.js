// سكربت Node.js شامل نهائي - متجر سوق عمان الكامل
// يشمل: صفحات المنتجات + الصفحة الرئيسية + صفحة السلة + صفحة checkout + الصفحات القانونية
const fs = require('fs');
...
.checkout-btn{width:100%;background:#25D366;color:white;border:none;padding:18px;border-radius:8px;font-size:18px;font-weight:bold;cursor:pointer;margin-top:20px;}
...
<a href="/index.html" style="display:block;text-align:center;margin-top:20px;color:#114c7d;font-weight:bold;">← متابعة التسوق</a>
</div>
</div>
${footer}
<script>
...
console.log('✓ تم إنشاء صفحة cart.html');
...
.submit-btn{width:100%;background:#25D366;color:white;border:none;padding:18px;border-radius:8px;font-size:18px;font-weight:bold;cursor:pointer;}
...
console.log('✓ صفحة رئيسية مع بطاقات المنتجات');
console.log('✓ صفحة السلة الاحترافية');
console.log('✓ صفحة إتمام الطلب (checkout)');
console.log('✓ 5 صفحات قانونية');
console.log('\n📱 جميع أزرار واتساب تتوجه لصفحة checkout');
console.log('✅ نموذج واحد احترافي لجمع البيانات');
console.log('✅ إرسال مباشر لواتساب مع كل التفاصيل');

// سكربت Node.js شامل - SEO + Sitemap + Google Merchant Feed
const fs = require('fs');
...
products.forEach(product => {
    ...
    <item>
      ...
      <g:description><![CDATA[${product.title} - منتج أصلي من سوق عمان بسعر ${product.sale_price} ريال عماني]]></g:description>
      <g:link>${productURL}</g:link>
      <g:image_link>${imageURL}</g:image_link>
      <g:condition>new</g:condition>
      <g:availability>in stock</g:availability>
      <g:price>${product.sale_price} OMR</g:price>
...
<meta name='description' content='اشترِ ${product.title} بسعر ${product.sale_price} ريال عماني فقط - شحن مجاني، توصيل خلال 3 أيام - متجر سوق عمان'>
...
console.log('\n📋 الخطوات التالية:');
console.log('1. ارفع الملفات للموقع');
console.log('2. أرسل sitemap.xml لـ Google Search Console');
console.log('3. أرسل products.xml لـ Google Merchant Center');
